 ...
 * @author GIGABYTE
 */
public class ttttt extends javax.swing.JDialog {

    /**
     * Creates new form ttttt
     */
    public ttttt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ttttt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ttttt dialog = new ttttt(new javax.swing.JFrame(), true);
