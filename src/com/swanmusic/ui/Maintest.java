...
public class Maintest extends javax.swing.JDialog {


    public Maintest(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        customSplitpaneUI();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Maintest dialog = new Maintest(new javax.swing.JFrame(), true);
